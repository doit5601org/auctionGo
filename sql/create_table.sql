...
, CONSTRAINT ACCOUNT_EVENT_TYPE_ACCOUNT_EVENT_TYPE_CODE_PK PRIMARY KEY(ACCOUNT_EVENT_TYPE_CODE)
...
, CONSTRAINT ACCOUNT_EVENT_HISTORY_USER_ID_FK FOREIGN KEY(USER_ID)
            REFERENCES USERS(USER_ID)
, CONSTRAINT ACCOUNT_EVENT_HISTORY_ACCOUNT_EVENT_TYPE_CODE_FK FOREIGN KEY(ACCOUNT_EVENT_TYPE_CODE)
...
, CONSTRAINT PRODUCT_PRODUCT_SIZE_CODE_FK FOREIGN KEY(PRODUCT_SIZE_CODE)
        REFERENCES PRODUCT_SIZE(PRODUCT_SIZE_CODE)
...
(
    ...
    , CONSTRAINT MONEY_CHARGE_METHOD_MONEY_CHARGE_METHOD_CODE_PK PRIMARY KEY (MONEY_CHARGE_METHOD_CODE)
...
,CONSTRAINT REPORT_RESULT_REPORT_RESULT_CODE_PK PRIMARY KEY(REPORT_RESULT_CODE)
