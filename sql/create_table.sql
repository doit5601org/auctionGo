...
, CONSTRAINT USER_ACCOUNT_USER_ID_FK FOREIGN KEY (USER_LOGIN_ID)
...
, CONSTRAINT USER_PROFILE_ZIPCODE_CK CHECK(LENGTH(USER_ZIP_CODE)BETWEEN 5 AND 6)
);
...
, CONSTRAINT DELETED_USER_ZIPCODE_CK CHECK(LENGTH(USER_ZIP_CODE)BETWEEN 5 AND 6)
);


-- ○ 5. 계정 이벤트 분류
CREATE TABLE ACCOUNT_EVENT_TYPE
( ACCOUNT_EVENT_TYPE_CODE   NUMBER  NOT NULL
, EVENT_NAME    VARCHAR2(50)    NOT NULL
, CONSTRAINT ACCOUNT_EVENT_TYPE_ACCUNT_EVENT_TYPE_CODE_PK PRIMARY KEY(ACCOUNT_EVENT_TYPE_CODE)
...
, CONSTRAINT ACCOUNT_EVENT_HISTORY_USER_ID_FK FOREIGN KEY(USER_ID)
            REFERENCES USER(USER_ID)
, CONSTRAINT ACCOUNT_EVENT_HISTRORY_ACCOUNT_EVENT_TYPE_CODE_FK FOREIGN KEY(ACCOUNT_EVENT_TYPE_CODE)
            REFERENCES ACCOUNT_EVENT_TYPE(ACCOUNT_EVENT_TYPE_CODE)
, CONSTRAINT ACCOUNT_EVENT_HISTORY_USER_ID_ACCOUNT_EVENT_TYPE_CODE_UK UNIQUE (USER_ID, ACCOUNT_EVENT_TYPE_CODE)
);


-- ○ 7. 관리자 권한 코드
CREATE TABLE ADMIN_ROLE
( ADMIN_ROLE_CODE   NUMBER  NOT NULL
, ADMIN_ROLE_NAME   VARCHAR2(50)    NOT NULL
, CONSTRAINT ADMIN_ROLE_ADMIN_ROLE_CODE_PK PRIMARY KEY(ADMIN_ROLE_CODE)
...
, CONSTRAINT ADMIN_ACCOUNT_ADMIN_ROLE_CODE_FK FOREIGN KEY(ADMIN_ROLE_CODE)
        REFERENCES ADMIN_ROLE(ADMIN_ROLE_CODE)
, CONSTRAINT ADMIN_LOGIN_ID_UK UNIQUE(ADMIN_LOGIN_ID)
, CONSTRAINT ADMIN_ACCOUNT_ID_CK CHECK(ADMIN_LOGIN_ID BETWEEN 4 AND 12)
, CONSTRAINT ADMIN_ACCOUNT_PW_CK CHECK(ADMIN_PASSWORD BETWEEN 8 AND 16)
);
...
-- ○ 11. 공통 여부 테이블
CREATE TABLE COMMON
( COMMON_YN_CODE    NUMBER(1)   NOT NULL
, COMMON_YN_NAME    CHAR(1) NOT NULL
, CONSTRAINT COMMON_COMMON_YN_CODE_PK PRIMARY KEY(COMMON_YN_CODE)
...
, CONSTRAINT PRODUCT_COUNTRY_PRODUCT_COUNTRY_CODE_PK PRIMARY KEY(PRODUCT_COUNTRY_CODE)
, CONSTRAINT PRODUCT_COUNTRY_NAME_UK UNIQUE(PRODUCT_COUNTRY_NAME)
, CONSTRAINT PRODUCT_COUNTRY_CODE_CK CHECK (LENGTH(PRODUCT_COUNTRY_CODE)=2) 
);


-- ○ 13. 상품 제조사
CREATE TABLE PRODUCT_MANUFACTURER
( MANUFACTURER_CODE NUMBER NOT NULL
, PRODUCT_COUNTRY_CODE CHAR(2) NOT NULL
, MANUFACTURER_NAME VARCHAR2(50) NOT NULL
, CONSTRAINT PRODUCT_MANUFACTURER_MANUFACTURER_CODE_PK PRIMARY KEY(MANUFACTURER_CODE)
, CONSTRAINT PRODUCT_MANUFACTURER_PRODUCT_COUNTRY_CODE_FK FOREIGN KEY(PRODUCT_COUNTRY_CODE)
            REFERENCES PRODUCT_COUNTRY(PRODUCT_COUNTRY_CODE)
, CONSTRAINT PRODUCT_MANUFACTURE_PRODUCT_COUNTRY_CODE_MANUFACTURER_NAME_UK UNIQUE(PRODUCT_COUNTRY_CODE, MANUFACTURER_NAME)
);
...
( PRODUCT_GRADE_CODE NUMBER NOT NULL
, PRODUCT_GRADE_NAME VARCHAR2(50)   NOT NULL
, CONSTRAINT PRODUCT_GRADE_PRODUCT_GRADE_CODE PRIMARY KEY(PRODUCT_GRADE_CODE)
...
( PRODUCT_GENRE_CODE    NUMBER  NOT NULL
, PRODUCT_GENRE_NAME    VARCHAR2(50)    NOT NULL
, CONSTRAINT PRODUCT_GENRE_PRODUCT_GENRE_CODE_PK PRIMARY KEY(PRODUCT_GENRE_CODE)
...
( PRODUCT_SIZE_CODE NUMBER  NOT NULL
, PRODUCT_SIZE_NAME VARCHAR2(10)    NOT NULL
, CONSTRAINT PRODUCT_SIZE_PRODUCT_SIZE_CODE_PK PRIMARY KEY(PRODUCT_SIZE_CODE)
...
, IS_PARTS_MISSING CHAR(1)  NOT NULL
...
, CONSTRAINT PRODUCT_USER_ID_FK FOREIGN KEY(USER_ID)
        REFERENCES USER(USER_ID)
, CONSTRAINT  PRODUCT_MANUFACTURER_CODE_FK FOREIGN KEY(MANUFACTURER_CODE)
        REFERENCES PRODUCT_MANUFACTURER(MANUFACTURER_CODE)
, CONSTRAINT PRODUCT_PRODUCT_GRADE_CODE_FK FOREIGN KEY(PRODUCT_GRADE_CODE)
        REFERENCES PRODUCT_GRADE(PRODUCT_GRADE_CODE)
, CONSTRAINT PRODUCT_PRODUCT_GENRE_CODE_FK FOREIGN KEY(PRODUCT_GENRE_CODE)
        REFERENCES PRODUCT_GENRE(PRODUCT_GENRE_CODE)
, CONSTRAINT PRODUCT_PRODUCT_SIZE_CODE_FK FOREIGN KEY(PRODUCT_SIZE_CODE)
        REFERENCES PRODUCT_SIZEPRODUCT_SIZE_CODE(PRODUCT_SIZE_CODE)
, CONSTRAINT PRODUCT_IS_OPENED_FK FOREIGN KEY(IS_OPENED)
        REFERENCES COMMON(COMMON_YN_CODE)
...
, CONSTRAINT MONEY_TYPE_MONEY_TYPE_CODE_PK PRIMARY KEY(MONEY_TYPE_CODE)
...
,CONSTRAINT REPORT_SUBMISSION_REPORT_TARGET_CODE_FK FOREIGN KEY(REPORT_TARGET_CODE)
                                                    REFERENCES REPORT_TARGET(REPORT_TARGET_CODE)
