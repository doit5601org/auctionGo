...
SELECT *
FROM USER_SEQUENCES
WHERE SEQUENCE_NAME LIKE ('ADMIN%');
...
VALUES(ADMIN_ACCOUNT_SEQ.NEXTVAL, 2, 'admin01' , '0123456789');
INSERT INTO ADMIN_ACCOUNT(ADMIN_ACCOUNT_ID, ADMIN_ROLE_ID, ADMIN_LOGIN_ID, ADMIN_PASSWORD) 
VALUES(ADMIN_ACCOUNT_SEQ.NEXTVAL, 1, 'admin02' , '0123456789');
...
-- 1번 회원에 대해 2번 관리자가 자동으로 1점을 부여
EXEC PRC_PENALTY_ASSIGN(1, 2, 1, 1);
...
-- 낙찰 결제 기한 확인
EXEC DBMS_SCHEDULER.RUN_JOB('SCH_AUCTION_CLOSE');

SELECT *
FROM AUCTION_WINNING_RESULT;
/*
BID_RESULT_ID     BID_ID CREATED_AT
------------- ---------- ----------
            2          1 2026-04-22
*/

INSERT INTO AUCTION_WINNING_RESULT(BID_RESULT_ID, BID_ID, CREATED_AT)
VALUES (BID_RESULT_SEQ.NEXTVAL, 1, TO_DATE('2026-04-22 14:05:00', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO BID_FAILURE_HISTORY(BID_FAIL_HISTORY_ID, BID_RESULT_ID,BID_FAIL_TYPE_ID,CREATED_AT)
VALUES(BID_FAIL_HISTORY_SEQ.NEXTVAL, 2, 2, SYSDATE);
...
FROM BID_FAILURE_TYPE;
/*
BID_FAIL_TYPE_ID BID_FAIL_TYPE_NAME                                
---------------- --------------------------------------------------
               1 결제기한만료                                       
               2 낙찰포기                                           
