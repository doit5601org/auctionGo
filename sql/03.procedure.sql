...
END;
/
exec PRC_BID_FAILURE_PROCESS(1,338)
SELECT *
FROM AUCTION_REGISTRATION
WHERE AUCTION_ID = 29
...
BEGIN
   SELECT NVL(SUM(
       CASE 
           WHEN MONEY_TYPE_ID = 8 THEN 30000
           WHEN MONEY_TYPE_ID IN (2, 3) THEN -ABS(AMOUNT)
           WHEN MONEY_TYPE_ID IN (4, 5) THEN ABS(AMOUNT)
           ELSE 0
       END
   ) * -1, 0) INTO RE
   FROM MONEY_TRANSACTION_HISTORY
   WHERE USER_ID = V_USER_ID
     AND MONEY_TYPE_ID IN (2, 3, 4, 5, 8);
