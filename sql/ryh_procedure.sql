...
BEGIN
    ...
    -- 진행 중인 낙찰이 있는지
        ...
        --     IF(V_HAS_BID=0 AND V_HAS_BID_2=0)THEN
...
-- 뷰	상품 목록 조회 뷰	VW_PRODUCT_LIST
-- 뷰	상품 상세 조회 뷰	VW_PRODUCT_DETAIL
-- 뷰	공개 상품 조회 뷰	VW_PUBLIC_PRODUCT_LIST
-- 뷰	내 상품 조회 뷰	VW_MY_PRODUCT_LIST
...
-- 뷰	머니 잔액 조회 뷰	VW_USER_MONEY_BALANCE
