		...
		<div class="body2">
			<div>
				...
				<div class="termcontent">
					<span class="con">탈퇴시 회원정보 및 서비스 이용 기록은 몇년뒤 삭제됩니다 회원 정보 및
						상품등록 경매기록 등은 이후 분쟁 및 .... 회원 탈퇴 약관에 대한 내용</span> <br />
			...
			<div>
				...
				<div class="termcontent">
					<span class="con">회원님의 머니는 예치금과 머니를 통합하여 충전된 금액은 본인계좌로 환불됩니다
						.... 회원 탈퇴 시 환불 약관에 대한 내용</span> <br />
					<ul class="list-group list-group-flush">
						<li class="list-group-item">이런거있고이런거있고이런거있고이런거있고이런거있고이런거있고이런거있고이런거있고이런거있고이런거있고이런거있고이런거있고이런거있고이런거있고이런거있고이런거있고이런거있고이런거있고이런거있고</li>
						<li class="list-group-item">이런거 있다</li>
						<li class="list-group-item">123</li>
				...
				<div class="form-check">
					<input class="form-check-input" type="checkbox" value=""
						id="checkmoneyIndeterminate"> <label class="form-check-label"
						for="checkmoneyIndeterminate"> 회원 탈퇴 시 환불 규정에 대한 약관을 확인 하였습니다 </label>
				</div>
			</div>
			<form action="" method="post" name="unregisterForm">
				<div class="ownercheck">
					<span style="color:red">*</span>&nbsp;<span>본인 확인을 위해 내용을 입력해주세요</span><br /><br />
					<div class="mb-3 row">
				...
				<div class="d-grid gap-2 col-6 mx-auto lastbtn">
					...
					<button class="btn btn-secondary" type="button" onclick="subm()">회원 탈퇴</button>
				</div>
			</form>
		</div>
	</div>
