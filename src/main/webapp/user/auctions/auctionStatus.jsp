							...
							<table class="table align-middle border-top">
								<thead class="table-light">
									<tr class="text-center">
										<th style="width: 40%">경매 상품 정보</th>
										<th style="width: 30%">입찰 현황 (1~3순위)</th>
									...
									<tr>
										<td>
											<div class="d-flex align-items-center">
												...
												<div>
													<div class="fw-bold">아이언맨 마크 85 피규어</div>
										...
										<td>
											<div class="small">
												<div class="d-flex justify-content-between mb-1">
													<span class="badge bg-danger">1순위</span> <span
														class="fw-bold text-danger">155,000원</span>
												</div>
												<div class="d-flex justify-content-between mb-1 text-muted">
													<span>2순위</span> <span>150,000원</span>
												</div>
												<div class="d-flex justify-content-between text-muted">
													<span>3순위</span> <span>148,000원</span>
												</div>
											</div>
										</td>
