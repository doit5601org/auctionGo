		...
		<div class="row">
			...
			<section class="col-md-9">
				<div class="d-flex align-items-center justify-content-between mb-4">
					...
					<a href="${pageContext.request.contextPath}/user/my/change-info"
						class="btn btn-outline-secondary btn-sm rounded-pill">정보 수정</a>
				</div>

				<div class="row g-3 mb-4">
					<div class="col-md-4"
						onclick="location.href='${pageContext.request.contextPath}/user/auctions/active'">
						<div class="card stat-card shadow-sm p-3 bg-white text-center">
							...
							<h4 class="mt-1 fw-bold">${auctionCnt }<span
									class="fs-6 fw-normal ms-1">건</span>
							</h4>
						</div>
					</div>
					<div class="col-md-4"
						onclick="location.href='${pageContext.request.contextPath}/user/bids/active'">
						<div class="card stat-card shadow-sm p-3 bg-white text-center">
							<div class="icon-box bg-success-subtle text-success mx-auto">
								<i class="bi bi-clock-history fs-4"></i>
							</div>
							<small class="text-muted fw-semibold">진행중인 입찰</small>
							<h4 class="mt-1 fw-bold">${bidCnt }<span
									class="fs-6 fw-normal ms-1">건</span>
							</h4>
						</div>
					</div>
					<div class="col-md-4"
						onclick="location.href='${pageContext.request.contextPath}/user/product/wishlist'">
						<div class="card stat-card shadow-sm p-3 bg-white text-center">
							<div class="icon-box bg-danger-subtle text-danger mx-auto">
								<i class="bi bi-heart-fill fs-4"></i>
							</div>
							<small class="text-muted fw-semibold">내 관심 상품</small>
							<h4 class="mt-1 fw-bold">${wishCnt }<span
									class="fs-6 fw-normal ms-1">건</span>
							</h4>
						</div>
					</div>
				...
				<div class="row g-3">
					<div class="col-md-6"
						onclick="location.href='${pageContext.request.contextPath}/payment.history'">
						<div
							class="card stat-card shadow-sm p-4 bg-white border-start border-2 border-primary"
							style="border-color: #120e63 !important;">
					...
					<div class="col-md-6"
						onclick="location.href='${pageContext.request.contextPath}/user/penalty'">
						<div
							class="card stat-card shadow-sm p-4 bg-white border-start border-2 border-danger">
							<div class="d-flex justify-content-between align-items-center">
								<div>
								...
								<div class="text-muted small">
									이력 확인 <i class="bi bi-chevron-right"></i>
								</div>
							</div>
						</div>
					</div>
