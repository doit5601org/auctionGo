	...
	<main class="container">
		<section class="row justify-content-center mt-5 mb-5">
			<div class="col-md-5 card p-4">
				...
				<form
					action="${pageContext.request.contextPath }/user/auth/find-id-action"
					method="post" id="findIdForm">
					<div class="mb-3">
						<label for="findIdName" class="form-label">이름 <span
							class="text-danger">*</span></label> <input type="text" id="findIdName"
							class="form-control" name="findIdName" /> <span
							class="text-danger ms-1 errMsg">이름을 입력해주세요.</span>
					</div>
					<div class="mb-3">
						<label for="findIdEmail" class="form-label">이메일 <span
							class="text-danger">*</span></label> <input type="email"
							class="form-control me-1" id="findIdEmail" name="findIdEmail">
