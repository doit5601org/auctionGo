...
<div class="container mt-4 mb-5" style="max-width:600px">
    ...
    <div class="card p-4">
        <div class="d-flex align-items-center gap-3 p-3 rounded mb-4" style="background-color:#e3f2fd">
            ...
            <div>
                <p class="fw-bold mb-0">하츠네 미쿠 1/7 스케일 피규어 경매</p>
                <p class="text-muted small mb-0">굿스마일컴퍼니 · S급 · 진행중</p>
            </div>
        </div>
        ...
        <form action="auction_report_act.do" method="post">
            <input type="hidden" name="auctionId" value="A001">
            <div class="mb-3">
            ...
            <div class="d-flex gap-2">
                <button type="button" class="btn btn-outline-secondary w-50" onclick="location.href='auctionDetail.jsp?auctionId=A001'">취소</button>
