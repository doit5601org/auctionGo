			...
			<div class="collapse navbar-collapse">
				<ul class="navbar-nav me-auto ms-3">
					<li class="nav-item"><a class="nav-link fw-semibold"
						href="productList.jsp">컬렉션</a></li>
					<%-- ${ctx}/product/list --%>
					<li class="nav-item"><a class="nav-link"
						href="auctionList.jsp">경매</a></li>
					<%-- ${ctx}/auction/list --%>
					<li class="nav-item"><a class="nav-link"
						href="productMyList.jsp">내 상품</a></li>
					<%-- ${ctx}/product/myList --%>
				</ul>
			</div>
		</div>
		...
		<div class="row g-4">
			...
			<div class="col-md-6">
				...
				<img src="https://placehold.co/360x360/e9ecef/6c757d?text=No+Image"
					class="main-img" id="mainImg" alt="샘플 이미지">
                ...
                --%>
					<%-- JSP 단독 실행용 샘플 썸네일 --%>
					<img src="https://placehold.co/70x70/e9ecef/6c757d?text=1"
						class="thumb-img active" onclick="changeImg(this)" alt=""> <img
						src="https://placehold.co/70x70/e9ecef/6c757d?text=2"
						class="thumb-img" onclick="changeImg(this)" alt=""> <img
						src="https://placehold.co/70x70/e9ecef/6c757d?text=3"
						class="thumb-img" onclick="changeImg(this)" alt="">
				</div>
			</div>
			...
			<div class="col-md-6">
				<div class="bg-white rounded-3 p-4 shadow-sm">
					<div class="mb-2">
						...
						<span class="badge bg-secondary me-1">S등급</span> <span
							class="text-muted small">굿스마일컴퍼니</span>
					</div>
					...
					<p class="small">내 피규어 소개글~~</p>
					<hr>

					<%-- 본인 상품이면 수정/삭제, 아니면 신고 버튼만 표시 --%>
					<%-- [Controller 연결 후 활성화]
<c:choose>
    ...
    <c:otherwise>
        <div class="text-end">
            <a href="${ctx}/product/report?productId=${product.productId}" class="btn btn-link btn-sm text-muted p-0 small text-decoration-none">
               신고하기
            </a>
        </div>
    </c:otherwise>
