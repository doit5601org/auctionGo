...
<div class="container mt-4 mb-5" style="max-width:680px">
    ...
    <div class="card p-4">
        <%-- [DB연결 후] form action="${ctx}/product/update" --%>
        <form action="productUpdate.jsp" method="post">
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-6">
                    ...
                    <select name="makerId" class="form-select form-select-sm" required>
                ...
                <%--
                    [DB연결 후] <c:forEach var="g" items="${genreList}">
                        <option value="${g.genreId}" <c:if test="${product.genreId eq g.genreId}">selected</c:if>>${g.genreName}</option>
                    </c:forEach>
                --%>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <%-- [DB연결 후] value="${product.releaseDate}" --%>
            ...
            <div class="row g-3 mb-4">
                <%--
                    [DB연결 후] 등급 radio checked 처리
                    <input type="radio" name="grade" value="S" <c:if test="${product.grade eq 'S'}">checked</c:if>>
                --%>
                <div class="col-md-4">
                    ...
                    <select name="grade" class="form-select form-select-sm" required>
                        <option value="S" selected>S급 (최상)</option>
                ...
                <div class="col-md-4">
                    ...
                    <%-- [DB연결 후] <c:if test="${product.openedYn eq 'N'}">selected</c:if> --%>
                ...
                <div class="col-md-6">
                    ...
                    <%-- [DB연결 후] value="${product.purchaseDate}" --%>
                ...
                <div class="col-12">
                    ...
                    <%-- [DB연결 후] 태그 사이에 ${product.description} --%>
                    <textarea name="description" class="form-control form-control-sm" rows="5">정품 굿스마일컴퍼니 하츠네 미쿠 1/7 스케일 피규어입니다.
