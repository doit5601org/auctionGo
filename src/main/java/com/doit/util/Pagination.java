...
public class Pagination {
   ...
   public String paging(int currentPage, int totalPage, String listUrl) {
      ...
      result.append("<ul class='pagination pagination-sm justify-content-center'>");
      ...
      {
         if (page==currentPage)
            result.append("<li class='page-item active'><span class='page-link'>" + page + "</span></li>");
         else
   ...
   {
      return "<li class='page-item'><a class='page-link' href='"+ url +"page="+ page +"'>" + label + "</a></li>";
   }
